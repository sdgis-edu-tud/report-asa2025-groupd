...
![Public amenities along Bila Nisa stream](Inserted_images/Quality of Life/Bila Nisa Jablonec - Public amenities data input.png)
...
![Normalized map size of public amenities](Inserted_images/Quality of Life/Bila Nisa Jablonec - Size of public areas normalized.png) ![Diversity of public amenities along Bila Nisa](Inserted_images/Quality of Life/Bila Nisa Jablonec - Diversity public areas normalized.png) Apart from essential public amenities, the accessiblity of nature and public green offer comfort in urban areas and is an important factor to be taken into account. As stated in the case, ecological quality of the stream has been degregated through human activity, which also impacts the quality of life in the proximity of the stream. However, along the borders of the urban area, patches of green over access to public green.

![Map showing public green along Bila Nisa stream](Inserted_images/Quality of Life/Bila Nisa Jablonec - Access public green along stream data input.png) The area of public green is then further normalized, through the following formula, thus normalizng the area on a scale from 0 to 1.
...
Our approach to out topology construction is embedded im our main reserach questions and goals. Based on our analysis we formulated the following guiding question for finding relevant topologies in Jablonec nad Nisou.

"which areas could serve different green-blue functions?"

In order to answer this question and find suitable topologies, we perform a K-means Clustering with the following datasets - one per respective areas topic.
