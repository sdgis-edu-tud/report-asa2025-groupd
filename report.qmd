...
***Access to Stream***
How well the urban stream can be accessed can be analyzed through the level of integration of the existing road network to determine centralities along the Bila Nisa. For this analysis, the road network of Jablonec nad Nisau is extracted from Open Street Map services and a space syntax analysis is conducted using Angular Integration to determine how central areas are. A clip mask focusing on the areas close to the Bila Nisa is made and overlayed on the grid resulting in the following map. 
...
[@public_transport_Jablonec_nad_Nisau]
