...
We set a fixed seed to ensure reproducibility and ran the K-means algorithm using k = 5. Each grid cell was assigned a cluster label.

*Step 4: Visualizing Clusters*
We explored the distribution of clusters both spatially and in feature space.

2D Map: Shows how clusters are arranged geographically.

3D Plot: Visualizes how clusters are separated in terms of indicator values (3 axes: NDVI, natural habitat, access).
