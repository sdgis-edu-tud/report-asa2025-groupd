...
The biodiversity chapter aims to follow the following sub-question: \> *Where can the ecological quality of the stream area be enhanced?*

This question is further divided into the following questions: \> *Which Areas Have High Biodiversity Value?* \> *Which Areas Have a High Level of Human Activity?* \> *Which Areas Provide Opportunity for Improved Biodiversity?*
...
#### Biodiversity Criteria Maxtrix

Using the Saaty matrix, each criterion is weighted against each other to give each criterion a priority based on their importance for urban stream restoration. Each topic (biodiversity, climate adaptation and quality of life) has its own matrix to create a consistent assessment.
...
The climate adaptation chapter aims to follow the following sub-question: \> *Where along the stream can flood mitigation measures take place?*

This question is further divided into the following questions: \> *Which Areas Have Highest Flood Damage Risk?* \> *Which Areas Have The Most Impervious Surfaces?* \> *Which Areas Have Healthy Vegetation?*
...
#### Climate Adaptation Criteria Maxtrix

Using the Saaty matrix, each criterion is weighted against each other to give each criterion a priority based on their importance for urban stream restoration.
...
The climate adaptation chapter aims to follow the following sub-question: \> *Which areas along the stream need improvements for quality of life to address stakeholder conflicts?*

This question is further divided into the following questions: \> *Which Areas Are Deprived of Public Facilities?* \> *Which Areas Lack Infrastructure to Access?* \> *Which Areas Can Be Physically Uncomfortable?*
...
#### Quality of Life Criteria Maxtrix
