...
The three criteria for the sub-question are aggregated based on their weights and combined into an intermediate map which shows areas along the stream with high biodiversity value.
...
The two criteria for the sub-question are aggregated based on their weights and combined into an intermediate map which shows areas along the stream with a high level of human activity.
...
The three criteria for the sub-question are aggregated based on their weights and combined into an intermediate map which shows areas along the stream with a potential for improved biodiversity.
