...
The typology construction with k means clustering further supports the analysis by classifying the stream corridor into five spatial types based on natural habitat, vegetation health, flood exposure, and access. These classifications give insight into what the challenging areas are by analysing the normalized data. This gives specific grid cells where most improvement is possible.

In summary, the combination S-MCDA and k-means clustering. The results can guide local authorities, urban designers, and environmental planners in developing actions that balance ecological needs with urban development. This work contributes to the goals of the ReBioClim framework by highlighting where multifunctional green-blue infrastructure can improve biodiversity, climate adaptation and quality of life in the city.
