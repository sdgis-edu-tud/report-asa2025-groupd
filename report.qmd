...
![ReBioClim Project Overview [@rebioclim_ioer2024].](Inserted_images/rebioclim_currentstate.png){fig-align="center" width="600"}
...
![Combination Map Biodiversity Question 1: Areas With High Biodiversity Value](Inserted_images/Biodiversity/Biodiversity%20Question%201.png)
...
![Combination Map Biodiversity Question 2: Areas With High Level of Human Activity](Inserted_images/Biodiversity/Biodiversity%20Question%202.png)
...
![Combination Map Biodiversity Question 3: Areas With Biodiversity Improvement Opportunities](Inserted_images/Biodiversity/Biodiversity%20Question%203.png)
...
![Concluding Biodiversity Map](Inserted_images/Biodiversity/Final%20Biodiversity%20Map.png)
...
![Impervious_norm](Inserted_images/Climate%20Adaptation/Normalised_Mean_Impervious_v2.png)
...
![LST_norm](Inserted_images/Climate%20Adaptation/Normalised_Mean_LST_v2.png)
...
![NDVI_norm](Inserted_images/Climate%20Adaptation/Normalised_Mean_NDVI_v2.png)
...
![Concluding climate adaptation S-MCDA Map](Inserted_images/Climate%20Adaptation/con%20climate%20map-01.png) The final conclusding map reveals that two industrial sites along the stream exhibit particularly low adaptive capacity to flood risk, suggesting a pressing need for the implementation of resilience-based flood mitigation measures. Additionally, a sports field with impervious surfaces located between these two industrial areas was also identified as an area requiring improvement in surface permeability to enhance its flood adaptation performance.
...
![Map showing public green along Bila Nisa stream](Inserted_images/Quality%20of%20Life/Bila%20Nisa%20Jablonec%20-%20Access%20public%20green%20along%20stream%20data%20input.png)The layer shows the available public green areas, retrieved from Open Map Services data. A clip mask has been made to overlay it on the grid layer using the mean values. The area of public green per grid cell is then normalized on a 0 to 1 scale using the formula underneath.
...
![Normalised Mean Tree Cover Percentage](Inserted_images/Quality%20of%20Life/Normalised_Mean_treecover_v2.png)
...
![Urban life conditions along the Stream](Inserted_images/Quality%20of%20Life/URBAN%20LIFE%20CONDITIONS.png)
...
![Combined and weighted quality of life map](Inserted_images/Bila%20Nisa%20Jablonec%20-%20Combined%20Quality%20of%20Life.png)
