...
100 meters is a common grid cell size used in the spatial analysis of general environmental conditions, as can be seen in reports on mitigating heat stress (Wang et al., 2022), land use, population, economic (Paprotny & Mengel, 2022) and urban heat islands (Lauwaet et al., 2023) analysis. Meanwhile a raster size of 50 meters is more useful in analysis where spatial conditions, characteristics and typo-morphologies are examined, along with their influence on environmental conditions (see reports: Chen et al., 2023; Song et al., 2020; Wong et al., 2012). 
...
The conducted analysis reflects this variation, using satellite data for broader patterns such as LST and impervious surfaces. This data is then supplemented with higher-resolution sources for space syntax calculations, biotope values and ecologically valuable habitats, to name a few. The collected data for each respective goals can be found in the figures below.
