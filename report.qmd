...
For the first sub-question, “Which areas have the highest flood damage risk?”, the attribute Flood Impact Zones in Floodplains carries a weight of 0.411, indicating it is a critical factor in identifying areas susceptible to flood damage.

The second sub-question, “Which areas have more impervious surfaces?”, includes two attributes: Impervious Surfaces (0.290) and Night Land Surface Temperature (0.100). Impervious surfaces directly affect the area's ability to absorb water, while higher night land surface temperatures typically indicate denser built environments with less green cover.

For the third sub-question, “Which areas have healthy vegetation?”, the attribute NDVI (Normalized Difference Vegetation Index) is used, with a weight of 0.199. Areas with higher NDVI values suggest healthier and denser vegetation, which can contribute to climate resilience by reducing surface runoff and moderating urban heat effects.
...
! introduction ! purpose of research question, why does it help answer the main question?
