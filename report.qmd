...
! add figure explaining workflow of project -\> key problems -\> research questions -\> sub-questions
...
The biodiversity chapter aims to follow the following sub-question:
...
| 2 (Orange) | Low | Low | Low | **High** | High-access area with limited vegetation or habitat. Here there is potential for **urban greening or recreational upgrades.** Their moderate flood risk indicates a need for **climate adaptation strategies.**​ |
| 3 (Yellow) | Low | Moderate | Low | Low | This typology consists of degraded areas with limited vegetation, biodiversity, and accessibility. This is suitable for **buffer zones or low-impact enhancement.**​ |
| 4 (Green) | Moderate | Moderate | Moderate | Moderate | Although these areas are classified as having **high natural habitat**, they exhibit **low vegetation health or cover**. Stream access is also limited. This could indicate sparse but valuable habitats.​ |
| 5 (Blue) | Low | Low | **High** | Low | Flood-exposed, degraded zone. Here we can prioritize **wetland restoration or flood-resilient interventions.**​ |
