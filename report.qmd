...
Using the Saaty matrix, each criteria are weighted against each other to give each criterion a priority based on their importance for urban stream restoration. Each topic (biodiversity, climate adaptation and quality of life) has its own matrix to create a consistent assessment.
...
Using the Saaty matrix, each criteria are weighted against each other to give each criterion a priority based on their importance for urban stream restoration.
