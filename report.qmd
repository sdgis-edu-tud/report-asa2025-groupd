...
![Concluding climate adaptation S-MCDA Map](Inserted_images/Climate%20Adaptation/con%20climate%20map-01.png){width="500"}
...
The methodology used in this analysis combines multiple spatial vector datasets and a structured decision-making approach (S-MCDA) to support urban and environmental planning. This process allowed for an assessment by including both environmental and social indicators. While some datasets, like biodiversity, provided detailed information, others, such as air quality, were more general.

One key aspect of the methodology was the use of different grid cell sizes 50x50 meters in urban areas and 100x100 meters in rural areas. This approach helped show more detail in the urban environments more accurately. However, using two different grid sizes also introduced some challenges. It made it harder to compare certain results across the whole study area, as some indicators only make sense at one scale.

Data availability also shaped the analysis. Open-source data was useful and accessible, but some layers lacked the level of detail needed for a deeper analysis. The choice of a 100-meter buffer around the Bílá Nisa stream focused the study area but may have left out some important factors just outside this zone. A larger or adjustable buffer could have added more context, but it would also increase data processing.

The positioning of the grid itself also played a role. Even small changes in where the grid is placed can affect the outcome. While standardized grid sizes help make the results more consistent, the placement still matters and should be considered when interpreting the results.

The analysis was based on static data, meaning it represents conditions at one point in time. However, urban and environmental factors often change with seasons, development, or climate conditions. This would be especially helpful for planning long-term projects like stream restoration.

The method used in this study was designed for Jablonec nad Nisou and the Bílá Nisa stream area, and it fits this context well. Still, applying it to other cities or landscapes would require adjustments in the S-MCDA.

Finally, once the clusters were formed, they had to be interpreted and labeled to be useful in planning. This step is necessary, but it also involves some subjective decisions.
