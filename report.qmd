...
Let's plot Polar charts of each cluster formed to help visualise what typological counterpart each cluster would represent. Based from these charts we can assign each cluster a correct typology.
...
Based on this we have assigned the following descriptions to each typology.

### Typology description

| Type (Cluster) | Natural Habitat | NDVI | Flood Zone | Stream Access | Description |
|--------|--------|--------|--------|--------|-----------------------------------|
| 1 (Red) | **High** | Low | Medium | Low | Ecologically valuable but inaccessible zone, suitable for habitat conservation. |
| 2 (Orange) | Medium | Medium | Medium | **High** | Accessible vegetated corridor, ideal for recreational enhancement and nature connection. |
| 3 (Yellow) | Medium | **High** | Medium | Medium | Healthy vegetation and moderate access, suitable for resilience interventions. |
| 4 (Green) | Medium | Medium | Medium | Medium | Balanced typology with moderate performance across all indicators — potential for multifunctional space improvement. |
| 5 (Blue) | Low | Low | **High** | Low | Flood-prone zone with limited vegetation and access, suitable for flood-resilient nature-based solutions like wetlands. |
