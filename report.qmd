...
High night-time temperatures indicate poor cooling and urban heat retention. Risk increases with rising LST, especially during summer heatwaves. In our case the values were collected between the summer months of the year 2022 (june to August). This is due to data availability of the data collected from the Terra (EOS AM-1) and Aqua (EOS PM-1) satellites by NASA. This data source was chosen as it contained the highest possible usable data resolution of 1 by 1 km. Based on the collected data and ranges found in Jablonec nad Nisou, the following table was constructed. 
| Indicator                | Low Risk Threshold (0) | High Risk Threshold (1) | Normalized Range (0–1) | Notes                                                  |
| ------------------------ | ---------------------- | ----------------------- | ---------------------- | ------------------------------------------------------ |
| Mean Night-Time LST (°C) | 11°C                   | 16°C                    | 0 – 1                  | 
