...
png(filename = "../../Inserted_images/radar_chart_clusters.png", width = 800, height = 600, res = 120)
...
ggsave(filename = "../Inserted_images/cluster_distances_histogram.png", plot = p, width = 8, height = 6, dpi = 300)
