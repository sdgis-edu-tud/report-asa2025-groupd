...
Accessiblity to nature and public green offer comfort in urban areas and is an important factor to be taken into account to determine if areas are liveable. As stated in the case of ReBioClim, ecological quality of the stream has been degregated over the years through human and industrial activity, resulting in a less liveable urban environment. There are some public green areas along the stream mainly located on the outskirts of the urban area, as can be seen in the map underneath.

![Map showing public green along Bila Nisa stream](Inserted_images/Quality%20of%20Life/Bila%20Nisa%20Jablonec%20-%20Access%20public%20green%20along%20stream%20data%20input.png)

The layer shows the available public green areas, retrieved from Open Map Services data. A clip mask has been made to overlay it on the grid layer using the mean values. The area of public green per grid cell is then normalized on a 0 to 1 scale using the formula underneath.
...
![Diversity of public amenities along Bila Nisa](Inserted_images/Quality%20of%20Life/Bila%20Nisa%20Jablonec%20-%20Diversity%20public%20areas%20normalized.png)
...
![Combined normalized layers of public goods availability](http://rstudio-server-edu.bk.tudelft.nl:8787/files/report-asa2025-groupd/Inserted_images/Quality%20of%20Life/AVAILABILITY%20PUBLIC%20GOODS.png)
...
***Access to Stream*** How well the urban stream can be accessed can be analyzed through the level of integration of the existing road network to determine centralities along the Bila Nisa. For this analysis, the road network of Jablonec nad Nisau is extracted from Open Street Map services and a space syntax analysis is conducted using Angular Integration to determine how central areas are. A clip mask focusing on the areas close to the Bila Nisa is made and overlayed on the grid resulting in the following map.

![Angular integration of road network indicating local centers](http://rstudio-server-edu.bk.tudelft.nl:8787/files/report-asa2025-groupd/Inserted_images/Quality%20of%20Life/Bila%20Nisa%20Jablonec%20-%20Access%20to%20stream%20data%20input.png) [@Roads_OSM]
...
![public transport access within stream area](http://rstudio-server-edu.bk.tudelft.nl:8787/files/report-asa2025-groupd/Inserted_images/Quality%20of%20Life/Bila%20Nisa%20Jablonec%20-%20Access%20public%20transport%20near%20stream%20data%20input.png) [@public_transport_Jablonec_nad_Nisau]
